...
As the data engineer, it is your job to create the ETL pipeline and data warehouse to support this analysis. You'll test your implementation by running queries from the Sparkify analytics team and compare their expected results with your results.
